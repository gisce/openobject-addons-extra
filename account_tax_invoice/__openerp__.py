...
##############################################################################
{
    "name": "Account Tax Evaluate on Invoice",
    "version": "1.0",
    "description": """
...
This module have contributions from:
- Gabriel Henao (Colditec)
- Juan Gonzales (http://serviciales.com)
- Industrias Fantasia de Colombia
    """,
    "author": "Cubic ERP",
